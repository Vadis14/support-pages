import { $ZodError, parse, parseAsync } from "./chunk-2PUJWEOP.js";
import { appendErrors, get, set } from "./chunk-RGQ5UHRZ.js";
...
var o = (e, t2) => {
  for (const o2 in t2.fields) {
    ...
    s3 && s3.ref && "reportValidity" in s3.ref
      ? r(s3.ref, o2, e)
      : s3 && s3.refs && s3.refs.forEach((t3) => r(t3, o2, e));
  }
};
var s = (r2, s3) => {
  ...
  for (var n2 = {}; r2.length; ) {
    ...
    if (
      ...
      n2[a2] = appendErrors(
        ...
        n2,
        s3,
        f ? [].concat(f, t2.message) : t2.message,
      );
    }
    r2.shift();
  }
...
function i2(r2, e) {
  for (var n2 = {}; r2.length; ) {
    ...
    if (
      ("invalid_union" === t2.code &&
        t2.errors.forEach(function (e2) {
...
function a(o2, a2, u) {
  if (
    ...
    (function (r2) {
      return (
        "_def" in r2 && "object" == typeof r2._def && "typeName" in r2._def
      );
    })(o2))
  )
      ...
      try {
        return Promise.resolve(
          t(
            function () {
              return Promise.resolve(
                o2["sync" === u.mode ? "parse" : "parseAsync"](n2, a2),
              ).then(function (e) {
                return (
                  c.shouldUseNativeValidation && o({}, c),
                  { errors: {}, values: u.raw ? Object.assign({}, n2) : e }
                );
              });
            },
            function (r2) {
      ...
      try {
        return Promise.resolve(
          t(
            function () {
              return Promise.resolve(
                ("sync" === u.mode ? parse : parseAsync)(o2, s3, a2),
              ).then(function (e) {
                return (
                  f.shouldUseNativeValidation && o({}, f),
                  { errors: {}, values: u.raw ? Object.assign({}, s3) : e }
                );
              });
            },
            function (r2) {
