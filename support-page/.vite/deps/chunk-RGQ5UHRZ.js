...
var useFormControlContext = () =>
  import_react.default.useContext(HookFormControlContext);
...
function useWatch(props) {
  ...
  const getCurrentOutput = import_react.default.useCallback(
    (values) => {
...
function useForm(props = {}) {
  ...
  _formControl.current.formState = import_react.default.useMemo(
