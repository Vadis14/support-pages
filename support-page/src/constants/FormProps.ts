  ...
  FormContainer: [
    {
      kind: "field",
      type: "text",
      placeholderKey: "form.name",
      name: "name",
      labelKey: "form.name",
      variant: "input_standart",
    },
    {
      kind: "field",
      type: "email",
    ...
    },
    {
      kind: "field",
      type: "text",
      placeholderKey: "form.message",
      name: "message",
      labelKey: "form.message",
      variant: "input_massage",
    },
    {
      kind: "field",
      type: "file",
      placeholderKey: "form.file",
      name: "file",
      labelKey: "form.file",
      variant: "input_file",
    },
